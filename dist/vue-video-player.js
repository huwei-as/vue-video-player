!(function(e, t) {
    "object" == typeof exports && "object" == typeof module ?
        ...
        (exports.VueVideoPlayer = t(require("video.js"))) :
        (e.VueVideoPlayer = t(e.videojs));
})(this, function(e) {
    return (function(e) {
        function t(i) {
                ...
                props: {
                    ...
                    globalOptions: {
                        ...
                        default: function() {
                            return {
                                controls: !0,
                                controlBar: { remainingTimeDisplay: !1, playToggle: {}, progressControl: {}, fullscreenToggle: {}, volumeMenuButton: { inline: !1, vertical: !0 } },
                                techOrder: ["html5"],
                                plugins: {},
                            };
                        },
                ...
                methods: {
                    initialize: function() {
                        ...
                        this.playsinline &&
                            ...
                            "" !== this.crossOrigin && ((this.$refs.video.crossOrigin = this.crossOrigin), this.$refs.video.setAttribute("crossOrigin", this.crossOrigin));
                        var n = function(t, n) {
                        ...
                        this.player = s(this.$refs.video, t, function() {
                            for (var e = this, t = a.concat(r.events).concat(r.globalEvents), i = {}, o = 0; o < t.length; o++)
                                "string" == typeof t[o] &&
                                void 0 === i[t[o]] &&
                                (function(t) {
                                    (i[t] = null),
                    ...
                    dispose: function(e) {
                        ...
                        this.player &&
                            this.player.dispose &&
                            ("Flash" !== this.player.techName_ && this.player.pause && this.player.pause(),
                                this.player.dispose(),
                                (this.player = null),
        ...
        function(e, t, n) {
            ...
            Object.defineProperty(t, "__esModule", { value: !0 }), (t.install = t.videoPlayer = t.videojs = void 0);
            var r = n(0),
                o = i(r),
                s = n(2),
                a = i(s),
        ...
        function(e, t, n) {
            ...
            var i = function() {
                    var e = this,
                        t = e.$createElement,
                        n = e._self._c || t;
                    return e.reseted ? n("div", { staticClass: "video-player" }, [n("video", { ref: "video", staticClass: "video-js" })]) : e._e();
                },
                r = [],
